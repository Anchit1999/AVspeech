...
class Pool:
	...
	"""
	def __init__(self, videos_dict, directory, num_workers, failed_save_file, compress, verbose, skip, log_file=None):
		"""
	...
	def feed_videos(self):
		...
		print("feed_videos")
		downloader.download_class_parallel(self.videos_dict, self.directory, self.videos_queue)
